...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrlw_features_2.setGeometry(QtCore.QRect(0, 0, 697, 498))
        ...
        self.gridLayout_3.addWidget(self.scrl_features_2, 1, 0, 1, 5)
        self.txt_img_filter_2 = QtGui.QLineEdit(self.layoutWidget_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.MinimumExpanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txt_img_filter_2.sizePolicy().hasHeightForWidth())
        self.txt_img_filter_2.setSizePolicy(sizePolicy)
        self.txt_img_filter_2.setObjectName(_fromUtf8("txt_img_filter_2"))
        self.gridLayout_3.addWidget(self.txt_img_filter_2, 0, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_reorder_pics, 0, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_clear_filter, 0, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btn_apply_filter, 0, 3, 1, 1)
        self.btn_hide_all = QtGui.QPushButton(self.layoutWidget_2)
        self.btn_hide_all.setObjectName(_fromUtf8("btn_hide_all"))
        self.gridLayout_3.addWidget(self.btn_hide_all, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_hide_all.setText(_translate("MainWindow", "Hide All", None))
