...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrlw_features_2.setGeometry(QtCore.QRect(0, 0, 697, 463))
        ...
        self.gridLayout_3.addWidget(self.scrl_features_2, 2, 0, 1, 5)
